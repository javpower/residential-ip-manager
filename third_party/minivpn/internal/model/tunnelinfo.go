...
type TunnelInfo struct {
	...
	// UsePeerID reports whether the server negotiated the P_DATA_V2 peer-id
	// header. Some OpenVPN-compatible servers do not push peer-id and require
	// the legacy P_DATA_V1 format.
	UsePeerID bool
}
